...
def load_model():
    ...
    state_dict = torch.load("model/G_A2B_final.pth", map_location=device)
...
st.write("Select a microstructure image and run the trained model.")

IMAGE_FOLDER = "test_images"

# ensure correct numeric order
image_files = sorted(
